 ...
 */
export declare function start(programs: AddedProgram[], accounts: AddedAccount[], computeMaxUnits?: bigint, transactionAccountLockLimit?: bigint, deactivateFeatures?: PublicKey[]): Promise<ProgramTestContext>;
/**
 ...
 * @returns A container for stuff you'll need to send transactions and interact with the test environment.
 */
export declare function startAnchor(path: string, extraPrograms: AddedProgram[], accounts: AddedAccount[], computeMaxUnits?: bigint, transactionAccountLockLimit?: bigint, deactivateFeatures?: PublicKey[]): Promise<ProgramTestContext>;
